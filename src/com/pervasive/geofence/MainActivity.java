...
import com.pervasive.geofence.GeofenceUtils.REMOVE_TYPE;
import com.pervasive.geofence.GeofenceUtils.REQUEST_TYPE;
...
public class MainActivity extends FragmentActivity 
{
    ...
    private Geofence mCurrentGeofence2;
...
//        }
	...
	public void onRegisterClicked(View view) {
        ...
        mCurrentGeofence   = new Geofence.Builder().setRequestId("1")
                ...
                .setCircularRegion(Double.valueOf( mLatitude1.getText().toString()), Double.valueOf(mLongitude1.getText().toString()),Float.valueOf(mRadius1.getText().toString()))
...
*/
        ...
        //mCurrentGeofences.add(mUIGeofence2.toGeofence());
         ...
         mCurrentGeofence2   = new Geofence.Builder().setRequestId("2")
                .setTransitionTypes(Geofence.GEOFENCE_TRANSITION_ENTER | Geofence.GEOFENCE_TRANSITION_EXIT)
                .setCircularRegion(Double.valueOf( mLatitude2.getText().toString()), Double.valueOf(mLongitude2.getText().toString()),Float.valueOf(mRadius2.getText().toString()))
                .setExpirationDuration(Geofence.NEVER_EXPIRE).build();
        
        mCurrentGeofences.add(mCurrentGeofence);
        mCurrentGeofences.add(mCurrentGeofence2);
